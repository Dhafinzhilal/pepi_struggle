...
@onready var panel_layout = get_node("/root/main/item_select/Control/PanelLayoutTile/VBoxContainer/LayerOption")
...
func place_tile():
	...
	tile_map.set_cell(0, mousepos,Global.current_tile,Vector2i(0,0))
	
func del_tile():
	global_position = get_global_mouse_position()
	var mousepos = tile_map.local_to_map(global_position)
	tile_map.set_cell(0, mousepos,-1,Vector2i(0,0))
